...
Функция НовыеПараметрыПоискаВГлубинуГрафа(СписокВершин, СписокСмежности)
	...
	ПараметрыПоиска.Вставить("СостоянияВершин", ?(КоличествоВершин = 0, Новый Массив, Новый Массив(КоличествоВершин)));
...
Функция СписокСмежности(СписокРебер, СписокВершин)
	...
	СписокСмежности = ?(КоличествоВершин = 0, Новый Массив, Новый Массив(КоличествоВершин));
